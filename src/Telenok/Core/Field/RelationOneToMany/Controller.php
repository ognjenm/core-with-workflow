...
class Controller extends \Telenok\Core\Interfaces\Field\Controller {
	...
	{
		return \Telenok\Core\Model\Object\Type::whereIn('id', [$field->relation_one_to_many_has, $field->relation_one_to_many_belong_to])->first();
	}
    ...
    public function getFilterQuery($field = null, $model = null, $query = null, $name = null, $value = null) 
    {
		if (!empty($value))
		{
			...
			else
			{
				...
				$linkedTable = \Telenok\Core\Model\Object\Sequence::getModel($field->relation_one_to_many_has)->code;
    ...
    public function saveModelField($field, $model, $input)
    {
        ...
        { 
            ...
            $relatedModel = \App::build(\Telenok\Core\Model\Object\Type::findOrFail($field->relation_one_to_many_has)->class_model);
    ...
    {
		$input->put('relation_one_to_many_has', intval(\Telenok\Core\Model\Object\Type::where('code', $input->get('relation_one_to_many_has'))->orWhere('id', $input->get('relation_one_to_many_has'))->pluck('id')));
    ...
    public function postProcess($model, $type, $input)
    {
        try 
        {
            ...
            $typeBelongTo = \Telenok\Core\Model\Object\Type::findOrFail($model->relation_one_to_many_has); 
