    ...
    try {//ie8 throws some harmless exception, so let's catch it
            ...
            jQuery('#avatar').editable({
                ...
                url: function(params) {
                            ...
                            var value = jQuery('#avatar').next().find('input[type=hidden]:eq(0)').val();
                    ...
                    <div class="profile-contact-info">
                        <div class="profile-contact-links align-left">
                            <a class="btn btn-link" href="#">
                                <i class="fa fa-plus-circle bigger-120 green"></i>
                                Add as a friend
                            </a>
                        ...
                        <div class="profile-social-links center">
                            <a href="#" class="tooltip-info" title="" data-original-title="Visit my Facebook">
                                <i class="middle fa fa-facebook-square fa-2x blue"></i>
                            </a>

                            <a href="#" class="tooltip-info" title="" data-original-title="Visit my Twitter">
                                <i class="middle fa fa-twitter-square fa-2x light-blue"></i>
                            </a>

                            <a href="#" class="tooltip-error" title="" data-original-title="Visit my Pinterest">
                                <i class="middle fa fa-pinterest-square fa-2x red"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="widget-box transparent">
                        <div class="widget-header widget-header-small">
                            <h4 class="blue widget-title smaller">
                                ...
                                <div id="profile-feed-1" class="profile-feed">
                                    <div class="profile-activity clearfix">
                                        ...
                                        <div class="tools action-buttons">
                                            <a href="#" class="blue">
                                                <i class="fa fa-pencil bigger-125"></i>
                                            </a>
                    ...
                    <div class="center">
                        <a href="#" class="btn btn-sm btn-primary">
                            ...
                            <i class="fa fa-on-right fa fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="nav nav-tabs padding-18">
                        ...
                        <li>
                            <a data-toggle="tab" href="#feed">
                                <i class="orange fa fa-rss bigger-120"></i>
                                Activity Feed
                            </a>
                        </li>
                                    ...
                                    <div class="profile-user-info">
                                        ...
                                        <div class="profile-info-row">
                                            <div class="profile-info-name">
                                                <i class="middle fa fa-facebook-square bigger-150 blue"></i>
                                            </div>
                                        ...
                                        <div class="profile-info-row">
                                            <div class="profile-info-name">
                                                <i class="middle fa fa-twitter-square bigger-150 light-blue"></i>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="widget-box transparent">
                                        <div class="widget-header widget-header-small">
                                            <h4 class="smaller">
                                                <i class="fa fa-check-square-o bigger-110"></i>
                                                Little About Me
                                            </h4>
                                        </div>
                                    ...
                                    <div class="inline position-relative">
                                        ...
                                        <div class="popover">
                                            ...
                                            <div class="popover-content">
                                                ...
                                                <div class="time">
                                                    <i class="fa fa-clock-o middle bigger-120 orange"></i>
                                                ...
                                                <div class="tools action-buttons">
                                                    <a href="#">
                                                        <i class="fa fa-facebook-square blue bigger-150"></i>
                                                    </a>

                                                    <a href="#">
                                                        <i class="fa fa-twitter-square light-blue bigger-150"></i>
                                                    </a>

                                                    <a href="#">
                                                        <i class="fa fa-google-plus-square red bigger-150"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="inline position-relative">
                                        ...
                                        <div class="popover">
                                            ...
                                            <div class="popover-content">
                                                ...
                                                <div class="time">
                                                    <i class="fa fa-clock-o middle bigger-120 grey"></i>
                                    ...
                                    <div class="inline position-relative">
                                        ...
                                        <div class="popover">
                                            ...
                                            <div class="popover-content">
                                                ...
                                                <div class="time">
                                                    <i class="fa fa-clock-o middle bigger-120 red"></i>
                            ...
                            <ul class="nav nav-tabs padding-16">
                                <li class="active">
                                    <a data-toggle="tab" href="#edit-basic">
                                        <i class="green fa fa-pencil-square-o bigger-125"></i>
                                        Basic Info
                                    </a>
                                </li>
                            ...
                            <div class="tab-content profile-edit-tab-content">
                                <div id="edit-basic" class="tab-pane in active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <span class="input-icon input-fa fa-right">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <span class="input-icon input-fa fa-right">
                                                ...
                                                <i class="fa fa-phone fa fa-flip-horizontal"></i>
                                            </span>
                                        </div>
                                    </div>
