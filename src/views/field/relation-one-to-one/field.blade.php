...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        {{ Form::select($linkedField, \Telenok\Core\Model\Object\Type::get(['title', 'id'])->transform(function($item) { return ['title' => $item->translate('title'), 'id' => $item->id]; })->toArray(), null, $domAttr) }}
    </div>
</div> 