<div class="widget-box">
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <div class="form-group">
                {{ Form::label('file_many_to_many_allow_ext', $controller->LL('property.file_many_to_many_allow_ext'), array('class'=>'control-label')) }}
                <div class="controls">
                    <select multiple="multiple" class="form-control" data-placeholder="{{{$controller->LL('property.file_many_to_many_allow_ext')}}}" id="file_many_to_many_allow_ext{{$uniqueId}}" name="file_many_to_many_allow_ext[]">
						...
						@foreach(\Telenok\Core\Model\File\FileExtension::all()->sort(function($a, $b) { return strcmp($a->extension, $b->extension); }) as $extension)
            ...
            <div class="form-group">
                {{ Form::label('file_many_to_many_allow_mime', $controller->LL('property.file_many_to_many_allow_mime'), array('class'=>'control-label')) }}
                <div class="controls">
                    <select class="" multiple="multiple" data-placeholder="{{{$controller->LL('property.file_many_to_many_allow_mime')}}}" id="file_many_to_many_allow_mime{{$uniqueId}}" name="file_many_to_many_allow_mime[]">
						...
						@foreach(\Telenok\Core\Model\File\FileMimeType::all()->sort(function($a, $b) { return strcmp($a->mime_type, $b->mime_type); }) as $mimeType)
