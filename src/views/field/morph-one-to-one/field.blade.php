...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        {{ Form::select($linkedField, \Telenok\Core\Model\Object\Type::get(['title', 'id'])->transform(function($item) { return ['title' => $item->translate('title'), 'id' => $item->id]; })->sortBy('title')->lists('title', 'id'), $model->$linkedField, $domAttr) }}
    </div>
</div> 