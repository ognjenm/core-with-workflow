									...
									@if ($field->allow_create)
                                        {
                                            ...
                                            "fnClick": function(nButton, oConfig, oFlash) {
                                                createO2MHas{{$jsUnique}}(this, '{{ URL::route($controller->getRouteWizardCreate(), [ 'id' => $field->relation_one_to_many_has ]) }}');
                                            }
                                        }
									@endif	
									...
									@if ($field->allow_choose)
                                        {
                                            ...
                                            "fnClick": function(nButton, oConfig, oFlash) {
                                                chooseO2MHas{{$jsUnique}}(this, '{{ URL::route($controller->getRouteWizardChoose(), ['id' => $field->relation_one_to_many_has]) }}');
                                            }
                                        }
									@endif	
                                    ]
