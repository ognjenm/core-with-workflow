...
class SeedGroupTable extends Migration {
	...
	public function up()
	{
		$modelGroupId = DB::table('object_type')->where('code', 'group')->pluck('id');
		...
		DB::table('object_field')->insertGetId(
				[
					...
					'code' => 'id',
					'active' => 1,
					'field_object_type' => $modelGroupId,
		...
		DB::table('object_field')->insert(
				[
					...
					'relation_many_to_many_has' => DB::table('object_type')->where('code', 'user')->pluck('id'),
					'multilanguage' => 0,
					'show_in_form' => 1,
					'show_in_list' => 0,
					'allow_search' => 1,
		...
		DB::table('object_field')->insert(
				[
					'id' => DB::table('object_sequence')->insertGetId(['id' => null, 'class_model' => '\Telenok\Core\Model\Object\Field']),
					'title' => json_encode(SeedGroupTableTranslation::get('group.field.code'), JSON_UNESCAPED_UNICODE),
					'title_list' => json_encode(SeedGroupTableTranslation::get('group.field.code'), JSON_UNESCAPED_UNICODE),
					'key' => 'string',
					'code' => 'code',
					'active' => 1,
					'field_object_type' => $modelGroupId,
