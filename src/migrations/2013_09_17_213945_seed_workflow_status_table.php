...
class SeedWorkflowStatusTable extends Migration {

	public function up()
	{
		if (Schema::hasTable('workflow_status'))
		{
			$modelStatusId = DB::table('object_type')->where('code', 'workflow_status')->pluck('id'); 
			...
			DB::table('object_field')->insertGetId(
					[
						...
						'code' => 'id',
						'active' => 1,
						'field_object_type' => $modelStatusId,
			...
			(new \Telenok\Core\Model\Object\Field())->storeOrUpdate(
					[
						'title' => SeedWorkflowStatusTableTranslation::get('workflow-status.field.code'),
						'title_list' => SeedWorkflowStatusTableTranslation::get('workflow-status.field.code'),
						'key' => 'string',
						'code' => 'code',
						'active' => 1,
						'field_object_type' => $modelStatusId,
...
class SeedWorkflowStatusTableTranslation extends \Telenok\Core\Interfaces\Translation\Controller {

	public static $keys = [
		'workflow-status' => [
			'title' => [
				'ru' => 'Бизнес-процесс: статус',
				'en' => 'Business-process: status',
			],
			'title_list' => [
				'ru' => 'Бизнес-процесс: статус',
				'en' => 'Business-process: status',
