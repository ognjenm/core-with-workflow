...
class SeedFileMimeTypeTable extends Migration {
	...
	public function up()
	{
		...
		{
			$modelId = DB::table('object_type')->where('code', 'file_mime_type')->pluck('id');
			...
			DB::table('object_field')->insertGetId(
					[
						'id' => DB::table('object_sequence')->insertGetId(['id' => null, 'class_model' => '\Telenok\Core\Model\Object\Field']),
						'title' => json_encode(['ru' => "Mime type", 'en' => "Mime type"], JSON_UNESCAPED_UNICODE),
						'title_list' => json_encode(['ru' => "Mime type", 'en' => "Mime type"], JSON_UNESCAPED_UNICODE),
						'key' => 'string',
						'code' => 'mime_type',
						'active' => 1,
						'field_object_type' => $modelId,
