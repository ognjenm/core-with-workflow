...
class SeedWorkflowEventTable extends Migration {
		...
		if (Schema::hasTable('workflow_event'))
		{
			...
			DB::table('object_field')->insertGetId(
					[
						...
						'code' => 'id',
						'active' => 1,
						'field_object_type' => $modelEventId,
...
class SeedWorkflowEventTableTranslation extends \Telenok\Core\Interfaces\Translation\Controller {
