...
class SeedWorkflowProcessTable extends Migration {
	...
	public function up()
	{
		...
		{
			$modelWPId = DB::table('object_type')->where('code', 'workflow_process')->pluck('id');
...
class SeedWorkflowProcessTableTranslation extends \Telenok\Core\Interfaces\Translation\Controller {
