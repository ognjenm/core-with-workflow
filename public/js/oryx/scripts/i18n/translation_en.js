...
if (!ORYX.I18N.BPELSupport)
    ORYX.I18N.BPELSupport = {};
...
if (!ORYX.I18N.BPELLayout)
    ORYX.I18N.BPELLayout = {};
...
if (!ORYX.I18N.BPEL4Chor2BPELSupport)
...
if (!ORYX.I18N.BPEL4ChorSupport)
    ORYX.I18N.BPEL4ChorSupport = {};
...
if (!ORYX.I18N.Bpel4ChorTransformation)
    ORYX.I18N.Bpel4ChorTransformation = {};
...
if (!ORYX.I18N.QueryVariant)
    ORYX.I18N.QueryVariant = {};
...
if (!ORYX.I18N.BPMN2DTRPXMI)
    ORYX.I18N.BPMN2DTRPXMI = {};
...
if (!ORYX.I18N.cpntoolsSupport)
    ORYX.I18N.cpntoolsSupport = {};
...
if (!ORYX.I18N.BPMN2YAWLMapper)
    ORYX.I18N.BPMN2YAWLMapper = {};
...
if (!ORYX.I18N.ProcessLogGenerator)
    ORYX.I18N.ProcessLogGenerator = {};
...
if (!ORYX.I18N.ProcessLogGenerator.completeness)
    ORYX.I18N.ProcessLogGenerator.completeness = {};
...
if (!ORYX.I18N.VisioBPMNImport)
    ORYX.I18N.VisioImport = {};
